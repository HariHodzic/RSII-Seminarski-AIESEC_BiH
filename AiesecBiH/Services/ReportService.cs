...
{
    public class ReportService : CRUDService<Model.Response.Report, Database.Report, Model.Search.Report, Model.Update.Report, Model.Insert.Report>,IReportService
    {
